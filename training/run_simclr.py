...
from core.simclr import data as data_lib
from core.simclr import metrics
from core.simclr import model as model_lib
from core.simclr import objective as obj_lib
...
def build_saved_model(model):
  ...
  input_spec1 = tf.TensorSpec(shape=[None, FLAGS.image_size, FLAGS.image_size, 6], dtype=tf.float32)
  input_spec2 = tf.TensorSpec(shape=[None, FLAGS.image_size, FLAGS.image_size, 3], dtype=tf.float32)
